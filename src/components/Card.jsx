        ...
        return (
            <motion.div
                ...
                <div className='flex justify-between'>
                    <FaRegFileAlt />
                    <CircleX onClick={handleDelete} size={20} /> </div>
                ...
                <div className='footer  absolute bottom-0  w-full left-0 '>
                    ...
                    {
                        data.tag.isOpen ? <div className={`tag flex justify-center items-center w-full py-4  ${data.tag.tagColor === "green" ? 'bg-green-600' : 'bg-blue-600'} `} >
